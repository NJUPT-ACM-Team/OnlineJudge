...
func (*ShowProblemRequest) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{0} }
...
func (*ShowProblemResponse) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{1} }
...
func (*ShowProblemResponse_Language) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{1, 0} }
...
func init() { proto.RegisterFile("api/show_problem.proto", fileDescriptor3) }
