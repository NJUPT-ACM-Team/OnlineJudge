...
func (*RegisterRequest) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{0} }
...
func (*RegisterResponse) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{1} }
...
func init() { proto.RegisterFile("api/register.proto", fileDescriptor6) }
