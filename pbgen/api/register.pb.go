...
func (*RegisterRequest) Descriptor() ([]byte, []int) { return fileDescriptor8, []int{0} }
...
func (*RegisterResponse) Descriptor() ([]byte, []int) { return fileDescriptor8, []int{1} }
...
func init() { proto.RegisterFile("api/register.proto", fileDescriptor8) }
