...
func (*ShowProblemRequest) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{0} }
...
func (*Problem) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{1} }
...
func (*ShowProblemResponse) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{2} }
...
func init() { proto.RegisterFile("api/show_problem.proto", fileDescriptor6) }
