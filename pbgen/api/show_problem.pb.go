...
func (*ShowProblemRequest) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{0} }
...
func (*Problem) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{1} }
...
func (*ShowProblemResponse) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{2} }
...
func init() { proto.RegisterFile("api/show_problem.proto", fileDescriptor10) }
