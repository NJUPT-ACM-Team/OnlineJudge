...
func (*ShowProblemRequest) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{0} }
...
func (*Problem) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{1} }
...
func (*ShowProblemResponse) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{2} }
...
func init() { proto.RegisterFile("api/show_problem.proto", fileDescriptor7) }
