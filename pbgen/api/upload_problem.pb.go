...
func (*UploadProblemRequest) Descriptor() ([]byte, []int) { return fileDescriptor11, []int{0} }
...
func (*UploadProblemResponse) Descriptor() ([]byte, []int) { return fileDescriptor11, []int{1} }
...
func init() { proto.RegisterFile("api/upload_problem.proto", fileDescriptor11) }
