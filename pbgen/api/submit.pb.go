...
func (*SubmitRequest) Descriptor() ([]byte, []int) { return fileDescriptor12, []int{0} }
...
func (*SubmitResponse) Descriptor() ([]byte, []int) { return fileDescriptor12, []int{1} }
...
func init() { proto.RegisterFile("api/submit.proto", fileDescriptor12) }
