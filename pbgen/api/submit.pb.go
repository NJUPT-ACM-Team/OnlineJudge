...
func (*SubmitRequest) Descriptor() ([]byte, []int) { return fileDescriptor11, []int{0} }
...
func (*SubmitResponse) Descriptor() ([]byte, []int) { return fileDescriptor11, []int{1} }
...
func init() { proto.RegisterFile("api/submit.proto", fileDescriptor11) }
