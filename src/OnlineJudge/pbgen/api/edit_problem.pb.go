...
func (*EditProblemRequest) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{0} }
...
func (*EditProblemResponse) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{1} }
...
func init() { proto.RegisterFile("api/edit_problem.proto", fileDescriptor4) }
