...
func (*RegisterRequest) Descriptor() ([]byte, []int) { return fileDescriptor12, []int{0} }
...
func (*RegisterResponse) Descriptor() ([]byte, []int) { return fileDescriptor12, []int{1} }
...
func init() { proto.RegisterFile("api/register.proto", fileDescriptor12) }
