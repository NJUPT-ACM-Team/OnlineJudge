...
func (*LoginInitRequest) Descriptor() ([]byte, []int) { return fileDescriptor12, []int{0} }
...
func (*LoginInitResponse) Descriptor() ([]byte, []int) { return fileDescriptor12, []int{1} }
...
func (*LoginAuthRequest) Descriptor() ([]byte, []int) { return fileDescriptor12, []int{2} }
...
func (*LoginAuthResponse) Descriptor() ([]byte, []int) { return fileDescriptor12, []int{3} }
...
func init() { proto.RegisterFile("api/login.proto", fileDescriptor12) }
