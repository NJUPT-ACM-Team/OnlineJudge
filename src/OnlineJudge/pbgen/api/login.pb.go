...
func (*LoginInitRequest) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{0} }
...
func (*LoginInitResponse) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{1} }
...
func (*LoginAuthRequest) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{2} }
...
func (*LoginAuthResponse) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{3} }
...
func init() { proto.RegisterFile("api/login.proto", fileDescriptor13) }
