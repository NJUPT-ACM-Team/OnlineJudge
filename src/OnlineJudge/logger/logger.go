...
func GetWebBackendLogger() *logging.Logger {
	return logging.MustGetLogger("webbackend")
}

func GetHandlerLogger() *logging.Logger {
	return logging.MustGetLogger("handler")
}

func GetDaemonLogger() *logging.Logger {
